<template>
  <q-carousel v-model="slide" vertical transition-prev="slide-down" transition-next="slide-up" swipeable animated
    ...
    <q-carousel-slide :name="product" class="column no-wrap flex-center" v-for='product in heavyList' :key="product">
      {{ product }}<LearnChartk :mydata="product"></LearnChartk>
    </q-carousel-slide>
  </q-carousel>
</template>
